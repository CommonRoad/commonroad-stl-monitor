...
def distance_to_left_bounds(vehicle_i: Vehicle, lanelet_ids: Iterable[int], world: World, time_step):
...
def distance_to_right_bounds(vehicle_i: Vehicle, lanelet_ids: Iterable[int], world: World, time_step):
    ...
    right_bounds = tuple(
        [
            l.right_vertices
            for l in lanelets
            if l.adj_right is None or l.adj_right not in lanelet_ids and l.adj_left_same_direction
        ]
    )
