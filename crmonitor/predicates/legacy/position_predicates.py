...
from crmonitor.common.helper import (OperatingMode, return_true_or_inf,
                                     return_false_or_minf, )
from crmonitor.common.road_network import RoadNetwork
from crmonitor.common.vehicle import Vehicle
from crmonitor.predicates.legacy.predicate_collection import (
    PredicateCollection, Constraint, ConstraintType, ConstraintRepresentation, )
...
class PositionPredicateCollection(PredicateCollection):
    ...
    def right_of_broad_lane_marking(
        self, time_step: int, vehicle: Vehicle, operating_mode: OperatingMode
    ) -> bool:
        """
    ...
    def left_of_broad_lane_marking(
        self, time_step: int, vehicle: Vehicle, operating_mode: OperatingMode
    ) -> bool:
        """
    ...
    def evaluate_predicates_online(
        ...
        if "right_of_broad_lane_marking__x_ego" in self._necessary_predicates:
            predicate_current_time_step["right_of_broad_lane_marking__x_ego"][
                ego_vehicle.id
        ...
        if "drives_leftmost__x_ego" in self._necessary_predicates:
            predicate_current_time_step["drives_leftmost__x_ego"][
                ego_vehicle.id
        ...
        for other_vehicle in other_vehicles:
            ...
            if "left_of_broad_lane_marking__x_o" in self._necessary_predicates:
                predicate_current_time_step["left_of_broad_lane_marking__x_o"][
                    other_vehicle.id
                ] = self.left_of_broad_lane_marking(
                    time_step, other_vehicle, operating_mode
                )
            if "on_access_ramp__x_o" in self._necessary_predicates:
                predicate_current_time_step["on_access_ramp__x_o"][
                    other_vehicle.id
            ...
            if "on_main_carriage_way__x_o" in self._necessary_predicates:
                predicate_current_time_step["on_main_carriage_way__x_o"][
                    other_vehicle.id
        ...
        for time_step in ego_vehicle.states_lon.keys():
            ...
            if "right_of_broad_lane_marking__x_ego" in self._necessary_predicates:
                predicate_trace["right_of_broad_lane_marking__x_ego"][ego_vehicle.id][
                    time_step
                ] = self.right_of_broad_lane_marking(
            ...
            if "main_carriageway_right_lane__x_ego" in self._necessary_predicates:
                predicate_trace["main_carriageway_right_lane__x_ego"][ego_vehicle.id][
                    time_step
                ] = self.main_carriageway_right_lane(
                    time_step, ego_vehicle, operating_mode
                )
