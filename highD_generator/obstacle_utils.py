...
def generate_dynamic_obstacle(scenario, vehicle_id, tracks_meta_df, tracks_df):
    ...
    initial_time_step = int(vehicle_tracks.frame.values[0])
    ...
    ys = filter_signal(-vehicle_tracks.y, polyorder=polyorder)
