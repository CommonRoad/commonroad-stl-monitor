...
class TestGeneralPredicates(unittest.TestCase):
    def setUp(self):
        ...
        self._traffic_sign_1 = TrafficSign(111, [traffic_sign_min_speed], {5}, np.array([0.0, 0.0]))
        traffic_sign_max_speed = TrafficSignElement(TrafficSignIDGermany.MAX_SPEED, ["10"])
        self._traffic_sign_2 = TrafficSign(111, [traffic_sign_max_speed], {5}, np.array([0.0, 0.0]))
    ...
    def test_in_standstill(self):
        ...
        # Monitor-Mode
        sol_monitor_mode_1 = general_predicates.in_standstill(0, ego_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_2 = general_predicates.in_standstill(1, ego_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_3 = general_predicates.in_standstill(2, ego_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_4 = general_predicates.in_standstill(3, ego_vehicle, OperatingMode.MONITOR)
        ...
        # Constraint-Mode
        sol_constraint_mode_1 = general_predicates.in_standstill(0, ego_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_2 = general_predicates.in_standstill(1, ego_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_3 = general_predicates.in_standstill(2, ego_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_4 = general_predicates.in_standstill(3, ego_vehicle, OperatingMode.CONSTRAINT)
        ...
        # Robustness-Mode
        sol_robustness_mode_1 = general_predicates.in_standstill(0, ego_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_2 = general_predicates.in_standstill(1, ego_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_3 = general_predicates.in_standstill(2, ego_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_4 = general_predicates.in_standstill(3, ego_vehicle, OperatingMode.ROBUSTNESS)
    ...
    def test_keeps_sign_min_speed_limit(self):
        ...
        # Monitor-Mode
        sol_monitor_mode_1 = general_predicates.keeps_sign_min_speed_limit(0, ego_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_2 = general_predicates.keeps_sign_min_speed_limit(1, ego_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_3 = general_predicates.keeps_sign_min_speed_limit(2, ego_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_4 = general_predicates.keeps_sign_min_speed_limit(3, ego_vehicle, OperatingMode.MONITOR)
        ...
        # Constraint-Mode
        sol_constraint_mode_1 = general_predicates.keeps_sign_min_speed_limit(0, ego_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_2 = general_predicates.keeps_sign_min_speed_limit(1, ego_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_3 = general_predicates.keeps_sign_min_speed_limit(2, ego_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_4 = general_predicates.keeps_sign_min_speed_limit(3, ego_vehicle, OperatingMode.CONSTRAINT)
        ...
        # Robustness-Mode
        sol_robustness_mode_1 = general_predicates.keeps_sign_min_speed_limit(0, ego_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_2 = general_predicates.keeps_sign_min_speed_limit(1, ego_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_3 = general_predicates.keeps_sign_min_speed_limit(2, ego_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_4 = general_predicates.keeps_sign_min_speed_limit(3, ego_vehicle, OperatingMode.ROBUSTNESS)
    ...
    def test_drives_faster(self):
        ...
        # Monitor-Mode
        sol_monitor_mode_1 = general_predicates.drives_faster(0, ego_vehicle, other_vehicle_1, OperatingMode.MONITOR)
        sol_monitor_mode_2 = general_predicates.drives_faster(1, ego_vehicle, other_vehicle_1, OperatingMode.MONITOR)
        sol_monitor_mode_3 = general_predicates.drives_faster(2, ego_vehicle, other_vehicle_1, OperatingMode.MONITOR)
        ...
        # Constraint-Mode
        sol_constraint_mode_1 = general_predicates.drives_faster(0, ego_vehicle, other_vehicle_1,
                                                                 OperatingMode.CONSTRAINT)
        sol_constraint_mode_2 = general_predicates.drives_faster(1, ego_vehicle, other_vehicle_1,
                                                                 OperatingMode.CONSTRAINT)
        sol_constraint_mode_3 = general_predicates.drives_faster(2, ego_vehicle, other_vehicle_1,
                                                                 OperatingMode.CONSTRAINT)
        ...
        # Robustness-Mode
        sol_robustness_mode_1 = general_predicates.drives_faster(0, ego_vehicle, other_vehicle_1,
                                                                 OperatingMode.ROBUSTNESS)
        sol_robustness_mode_2 = general_predicates.drives_faster(1, ego_vehicle, other_vehicle_1,
                                                                 OperatingMode.ROBUSTNESS)
        sol_robustness_mode_3 = general_predicates.drives_faster(2, ego_vehicle, other_vehicle_1,
                                                                 OperatingMode.ROBUSTNESS)
    ...
    def test_keeps_lane_speed_limit(self):
        ...
        # Monitor-Mode
        sol_monitor_mode_1 = general_predicates.keeps_lane_speed_limit(0, ego_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_2 = general_predicates.keeps_lane_speed_limit(1, ego_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_3 = general_predicates.keeps_lane_speed_limit(2, ego_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_4 = general_predicates.keeps_lane_speed_limit(3, ego_vehicle, OperatingMode.MONITOR)
        ...
        # Constraint-Mode
        sol_constraint_mode_1 = general_predicates.keeps_lane_speed_limit(0, ego_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_2 = general_predicates.keeps_lane_speed_limit(1, ego_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_3 = general_predicates.keeps_lane_speed_limit(2, ego_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_4 = general_predicates.keeps_lane_speed_limit(3, ego_vehicle, OperatingMode.CONSTRAINT)
        ...
        # Robustness-Mode
        sol_robustness_mode_1 = general_predicates.keeps_lane_speed_limit(0, ego_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_2 = general_predicates.keeps_lane_speed_limit(1, ego_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_3 = general_predicates.keeps_lane_speed_limit(2, ego_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_4 = general_predicates.keeps_lane_speed_limit(3, ego_vehicle, OperatingMode.ROBUSTNESS)
