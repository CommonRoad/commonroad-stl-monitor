...
class TestGeneralPredicates(unittest.TestCase):
    def setUp(self):
        ...
        traffic_sign_max_speed_1 = TrafficSignElement(TrafficSignIDGermany.MIN_SPEED, ["10"])
        self._traffic_sign_1 = TrafficSign(111, [traffic_sign_max_speed_1], {5}, np.array([0.0, 0.0]))
