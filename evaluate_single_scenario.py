...
def main():
    ...
    #filename = "./../../../commonroad/scenarios/tum_cps/scenarios/" + "NGSIM/" + "US101/USA_US101-27_2_T-1" + ".xml"
    filename = "./../../../commonroad/scenarios/tum_cps/scenarios/" + "SUMO/" + "ESP_Mad-1_9_T-1" + ".xml"
