...
\begin{itemize}
	\item The autonomous mode/monitor is deactivated in case of emergencies
	\item \todo{maybe consider only trucks and cars}
	\item rules for interstates are activated as soon as sign 330.1 is passed
\end{itemize}
