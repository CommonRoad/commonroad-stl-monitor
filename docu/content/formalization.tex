...
\begin{itemize}
	\item The autonomous mode is deactivated in case of 
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{\stvo  \S 18 (8) - English:} Stopping is prohibited, including on verges.
...
\paragraph{Comment:} We allow the ego vehicle to stop if a leading vehicle also stops. Vehicles may stop on the marked parking areas themselves, or at the parking areas at the
...
\paragraph{LTL formula:} G$((\congestionLeftPredicate \land \drivesMaxWithSlightlyHigherSpeedPredicate) \lor (\rightOfBroadLaneMarkingPredicate \land \leftOfBroadLaneMarkingPredicate) \quad\lor (\onAccessRampPredicate \land \neg \congestionLeftPredicate) \lor \neg \drivesFasterThanVehicleLeftPredicate)$
