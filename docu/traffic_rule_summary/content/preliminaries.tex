...
\big\{l'   \, \big| \, \forall l'', l''' \in (l \ \cup \ \mathrm{lane}_\mathrm{rear}(l')  \ \cup \ \mathrm{lane}_\mathrm{front}(l')):\mathrm{attr}(l'') = \mathrm{attr}(l''') \big\}.
\end{split}
\end{align}
\todo{Lane definition with several successor and predecessor lanelets, e.g. if a lane ends $\rightarrow$ distinction based on number of successors/predecessors?}
