...
from crmonitor.monitor.rtamt_monitor_stl import OfflineRtamtStlMonitor, OnlineRtamtStlMonitor
...
class TestRtamtStlMonitor:
    ...
    def test_offline_evaluation_correctness(self):
        monitor = OfflineRtamtStlMonitor(self.formula, self.predicates, self.dt)
        a = [1, 1, 0]
        b = [1, 0, 1]
    ...
    def test_online_evaluation_correctness(self):
        monitor = OnlineRtamtStlMonitor(self.formula, self.predicates, self.dt)
