...
class TestGeneralPredicates(unittest.TestCase):
    ...
    # def test_visualize_turning_left(self):
    #     scenario, _ = CommonRoadFileReader(
    #         str("scenarios/test_intersection/DEU_turningleft-1_1_T-1.xml")
    #     ).open(True)
    ...
    #             position=[25, 31.3],
    #             time_step=5,
    #             orientation=(2 / 3) * math.pi,
    #             velocity=10,
    #             acceleration=-100,
    #         ),
    #     }

    #     lanelets_p_vis = {0: {3}, 1: {5}, 2: {5}, 3: {7}, 4: {7}, 5: {20}}
    ...
    # plt.title("Robustness of turning left")
    # plt.show()
