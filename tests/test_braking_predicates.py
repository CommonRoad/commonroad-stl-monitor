...
from crmonitor.predicates.python.braking_predicates import \
...
class TestBrakingPredicates(unittest.TestCase):
    def setUp(self):
        config_path = os.path.dirname(
            os.path.abspath(__file__)) + "/../crmonitor/"
        ...
        self._simulation_param = create_simulation_param(
            config.get("simulation_param"), 1.0, 'DEU')
        self._other_vehicles_param = create_other_vehicles_param(
            config.get("other_vehicles_param"))
        self._ego_vehicle_param = create_other_vehicles_param(
            config.get("ego_vehicle_param"))
    ...
    def test_keeps_safe_distance(self):
        ...
        ego_vehicle = Vehicle(state_list_lon_ego, state_list_lat_ego,
                              ...
                              ObstacleType.CAR, self._ego_vehicle_param,
        ...
        other_vehicle = Vehicle(state_list_lon_other, state_list_lat_other,
                                Rectangle(5, 2), cr_state_list_other, 0,
                                ObstacleType.CAR, self._ego_vehicle_param,
                                lanelet_assignments_other, None, None, None)

        # Monitor-Mode
        sol_monitor_mode_1 = BrakingPredicateCollection.keeps_safe_distance_prec(
            0, ego_vehicle, other_vehicle, OperatingMode.MONITOR)
        sol_monitor_mode_2 = BrakingPredicateCollection.keeps_safe_distance_prec(
            1, ego_vehicle, other_vehicle, OperatingMode.MONITOR)
        self.assertEqual(exp_sol_monitor_mode_1, sol_monitor_mode_1)
        self.assertEqual(exp_sol_monitor_mode_2, sol_monitor_mode_2)

        # Constraint-Mode
        sol_constraint_mode_1 = BrakingPredicateCollection.keeps_safe_distance_prec(
            0, ego_vehicle, other_vehicle, OperatingMode.CONSTRAINT)
        sol_constraint_mode_2 = BrakingPredicateCollection.keeps_safe_distance_prec(
            1, ego_vehicle, other_vehicle, OperatingMode.CONSTRAINT)
        ...
        # Robustness-Mode
        sol_robustness_mode_1 = BrakingPredicateCollection.keeps_safe_distance_prec(
            0, ego_vehicle, other_vehicle, OperatingMode.ROBUSTNESS)
        sol_robustness_mode_2 = BrakingPredicateCollection.keeps_safe_distance_prec(
            1, ego_vehicle, other_vehicle, OperatingMode.ROBUSTNESS)
    ...
    def test_safe_distance(self):
        ...
        self.assertRaises(AssertionError,
                          BrakingPredicateCollection.safe_distance, 0, 0, -1, 0,
                          0)
        self.assertRaises(AssertionError,
                          BrakingPredicateCollection.safe_distance, 0, 0, 0, -1,
                          0)
    ...
    def test_brakes_stronger(self):
        ...
        state_list_lon_ego = {
            0: StateLongitudinal(a=-2),
            1: StateLongitudinal(a=-1),
            2: StateLongitudinal(a=1),
            3: StateLongitudinal(a=2)}
        state_list_lat_ego = {
            0: StateLateral(d=0, theta=0),
            1: StateLateral(d=0, theta=0),
        ...
        cr_state_list_ego = {
            0: State(acceleration=-1, time_step=0),
            1: State(acceleration=0, time_step=1),
            2: State(acceleration=0, time_step=2),
            3: State(acceleration=0, time_step=3)}
        ...
        state_list_lon_other = {
            0: StateLongitudinal(a=-1),
            1: StateLongitudinal(a=-2),
            2: StateLongitudinal(a=1),
            3: StateLongitudinal(a=1)}
        state_list_lat_other = {
            0: StateLateral(d=0, theta=0),
            1: StateLateral(d=0, theta=0),
            2: StateLateral(d=0, theta=0),
        ...
        # Monitor-Mode
        sol_monitor_mode_1 = BrakingPredicateCollection.brakes_stronger(0,
                                                                        ego_vehicle,
                                                                        other_vehicle,
                                                                        OperatingMode.MONITOR)
        sol_monitor_mode_2 = BrakingPredicateCollection.brakes_stronger(1,
                                                                        ego_vehicle,
                                                                        other_vehicle,
                                                                        OperatingMode.MONITOR)
        sol_monitor_mode_3 = BrakingPredicateCollection.brakes_stronger(2,
                                                                        ego_vehicle,
                                                                        other_vehicle,
                                                                        OperatingMode.MONITOR)
        sol_monitor_mode_4 = BrakingPredicateCollection.brakes_stronger(3,
                                                                        ego_vehicle,
                                                                        other_vehicle,
                                                                        OperatingMode.MONITOR)
        self.assertEqual(exp_sol_monitor_mode_1, sol_monitor_mode_1)
        ...
        # Constraint-Mode
        sol_constraint_mode_1 = BrakingPredicateCollection.brakes_stronger(0,
                                                                           ego_vehicle,
                                                                           other_vehicle,
                                                                           OperatingMode.CONSTRAINT)
        sol_constraint_mode_2 = BrakingPredicateCollection.brakes_stronger(1,
                                                                           ego_vehicle,
                                                                           other_vehicle,
                                                                           OperatingMode.CONSTRAINT)
        sol_constraint_mode_3 = BrakingPredicateCollection.brakes_stronger(2,
                                                                           ego_vehicle,
                                                                           other_vehicle,
                                                                           OperatingMode.CONSTRAINT)
        sol_constraint_mode_4 = BrakingPredicateCollection.brakes_stronger(3,
                                                                           ego_vehicle,
                                                                           other_vehicle,
                                                                           OperatingMode.CONSTRAINT)
        ...
        # Robustness-Mode
        sol_robustness_mode_1 = BrakingPredicateCollection.brakes_stronger(0,
                                                                           ego_vehicle,
                                                                           other_vehicle,
                                                                           OperatingMode.ROBUSTNESS)
        sol_robustness_mode_2 = BrakingPredicateCollection.brakes_stronger(1,
                                                                           ego_vehicle,
                                                                           other_vehicle,
                                                                           OperatingMode.ROBUSTNESS)
        sol_robustness_mode_3 = BrakingPredicateCollection.brakes_stronger(2,
                                                                           ego_vehicle,
                                                                           other_vehicle,
                                                                           OperatingMode.ROBUSTNESS)
        sol_robustness_mode_4 = BrakingPredicateCollection.brakes_stronger(3,
                                                                           ego_vehicle,
                                                                           other_vehicle,
                                                                           OperatingMode.ROBUSTNESS)
    ...
    def test_unnecessary_braking(self):
        ...
        left_vertices = np.array(
                [[0, 4], [10, 4], [20, 4], [30, 4], [40, 4], [50, 4], [60, 4],
                 [70, 4], [80, 4]])
        ...
        braking_predicates = BrakingPredicateCollection(road_network,
        ...
        other_vehicle_1 = Vehicle(state_list_lon_other_1,
                                  ...
                                  cr_state_list_other_1, 0, ObstacleType.CAR,
        ...
        other_vehicle_2 = Vehicle(state_list_lon_other_2,
                                  ...
                                  cr_state_list_other_2, 0, ObstacleType.CAR,
                                  self._ego_vehicle_param,
        ...
        # Monitor-Mode
        sol_monitor_mode_1 = braking_predicates.unnecessary_braking(0,
                                                                    ego_vehicle,
                                                                    other_vehicles,
                                                                    OperatingMode.MONITOR)
        sol_monitor_mode_2 = braking_predicates.unnecessary_braking(1,
                                                                    ego_vehicle,
                                                                    other_vehicles,
                                                                    OperatingMode.MONITOR)
        sol_monitor_mode_3 = braking_predicates.unnecessary_braking(2,
                                                                    ego_vehicle,
                                                                    other_vehicles,
                                                                    OperatingMode.MONITOR)
        sol_monitor_mode_4 = braking_predicates.unnecessary_braking(3,
                                                                    ego_vehicle,
                                                                    other_vehicles,
                                                                    OperatingMode.MONITOR)
        sol_monitor_mode_5 = braking_predicates.unnecessary_braking(4,
                                                                    ego_vehicle,
                                                                    other_vehicles,
                                                                    OperatingMode.MONITOR)
        sol_monitor_mode_6 = braking_predicates.unnecessary_braking(5,
                                                                    ego_vehicle,
                                                                    other_vehicles,
                                                                    OperatingMode.MONITOR)
        self.assertEqual(exp_sol_monitor_mode_1, sol_monitor_mode_1)
        ...
        # Constraint-Mode
        sol_constraint_mode_1 = braking_predicates.unnecessary_braking(0,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.CONSTRAINT)
        sol_constraint_mode_2 = braking_predicates.unnecessary_braking(1,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.CONSTRAINT)
        sol_constraint_mode_3 = braking_predicates.unnecessary_braking(2,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.CONSTRAINT)
        sol_constraint_mode_4 = braking_predicates.unnecessary_braking(3,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.CONSTRAINT)
        sol_constraint_mode_5 = braking_predicates.unnecessary_braking(4,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.CONSTRAINT)
        sol_constraint_mode_6 = braking_predicates.unnecessary_braking(5,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.CONSTRAINT)
        self.assertEqual(exp_sol_constraint_mode_1, sol_constraint_mode_1.value)
        ...
        # Robustness-Mode
        sol_robustness_mode_1 = braking_predicates.unnecessary_braking(0,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.ROBUSTNESS)
        sol_robustness_mode_2 = braking_predicates.unnecessary_braking(1,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.ROBUSTNESS)
        sol_robustness_mode_3 = braking_predicates.unnecessary_braking(2,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.ROBUSTNESS)
        sol_robustness_mode_4 = braking_predicates.unnecessary_braking(3,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.ROBUSTNESS)
        sol_robustness_mode_5 = braking_predicates.unnecessary_braking(4,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.ROBUSTNESS)
        sol_robustness_mode_6 = braking_predicates.unnecessary_braking(5,
                                                                       ego_vehicle,
                                                                       other_vehicles,
                                                                       OperatingMode.ROBUSTNESS)
        self.assertEqual(exp_sol_robustness_mode_1, sol_robustness_mode_1)
