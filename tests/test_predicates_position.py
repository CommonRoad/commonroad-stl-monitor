...
class TestPositionPredicates(unittest.TestCase):
    ...
    def test_Left_right_of_broad_lane_marking(self):
        ...
        self.assertEqual(
            exp_sol_monitor_mode_1_left, sol_robustness_monitor_mode_1 >= 0
        )
        ...
        self.assertEqual(
            exp_sol_monitor_mode_2_left, sol_robustness_monitor_mode_2 >= 0
        )
        ...
        self.assertEqual(
            exp_sol_monitor_mode_3_left, sol_robustness_monitor_mode_3 >= 0
        )
        ...
        self.assertEqual(
            exp_sol_monitor_mode_4_left, sol_robustness_monitor_mode_4 >= 0
        )
        ...
        self.assertEqual(
            exp_sol_monitor_mode_5_left, sol_robustness_monitor_mode_5 >= 0
        )
        ...
        self.assertEqual(
            exp_sol_monitor_mode_6_left, sol_robustness_monitor_mode_6 >= 0
        )
        ...
        self.assertEqual(
            exp_sol_monitor_mode_7_left, sol_robustness_monitor_mode_7 >= 0
        )
    ...
    #     lanelet_assignments_k = {0: {19}, 1: {19}, 2: {2}, 3: {2}}
    ...
    def test_on_oncom_of(self):
        ...
        #     lanelets_p_vis[ts] = 1
        #     x_p = x_p + random.uniform(2.5, 3.5)
        ...
        #     lanelets_k_vis[ts] = 1
        #     x_k = x_k - random.uniform(0.1, 2.0)
        ...
        #     print(
        #         f"k_position: {vehicle_k_vis.state_list_cr[ts].position}\tp_position: {vehicle_p_vis.state_list_cr[ts].position}\n"
        #     )
        #     if ts < 11:
        #         rob = (-1) * rob
        #     robs.append(rob)
        ...
        # plt.title("Robustness of on_oncom_of")
        # plt.show()
